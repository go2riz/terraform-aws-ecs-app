locals {
  autoscaling_enabled = var.autoscaling_cpu || var.autoscaling_memory
}
...
# Wait after registering scalable target (AWS eventual consistency)
...
resource "aws_appautoscaling_policy" "cpu" {
  ...
  # ensure target is registered before policy
